...
#define SlectPin 25
extern volatile unsigned char bleconnect_flag;
...
/************
bluetooth update display
************/
void Blue_update_display()
{
	if(bleconnect_flag==0)
	{
		PowerOff_key();//stm32 poweroff
	}
	else
	{
		PowerOn_key();//stm32 poweron for display
	}
